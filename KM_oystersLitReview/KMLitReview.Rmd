...
As it turns out, autotrophic plant production is not the whole story. Let's zoom out from the macroscopic world for a moment to meet the three domains of life: Bacteria, Archaea, and Eukarya. As humans, we belong to the domain Eukarya, which contains all life forms whose cell(s) have membrane-bound nuclei. In contrast, all organisms of the domains Bacteria and Archaea are not only microscopic, single-celled organisms, but prokaryotes as well–meaning they have "simple," prehistoric structures as opposed to membrane-bound organelles. Instead of containing structures that perform a metabolic pathway from start to finish–like how food is passed from mouth to esophogus to stomach to small intestine, etc., in our digestive systems–microbial communities are reliant on each other for the completion of comparable processes. However, let their simplicity not be misconstrued for irrelevance to our lives; microbes can
